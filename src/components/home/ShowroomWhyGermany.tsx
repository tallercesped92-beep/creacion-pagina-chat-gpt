  ...
  const advantages = [
    {
      num: "01",
      title: "MÁS MERCADO",
      desc: "Mayor volumen de oferta.",
    },
    {
      num: "02",
      title: "MÁS OPCIONES",
      desc: "Más configuraciones y equipamiento.",
    },
    {
      num: "03",
      title: "MÁS CONTROL",
      desc: "Historiales y documentación.",
    },
    {
      num: "04",
      title: "DECISIÓN INFORMADA",
      desc: "Análisis técnico y económico antes de reservar.",
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column: Text & Minimalist Editorial Advantages */}
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <h2 className="font-display text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight uppercase leading-[1.06] text-[#F3F2EF] mb-6">
              ...
              MÁS OPCIONES.
              <br />
              <span className="text-[#F3F2EF]">MÁS CONTROL.</span>
            </h2>

            {/* Compact Text */}
            <p className="text-base sm:text-lg text-[#F3F2EF]/80 font-light leading-relaxed mb-8 max-w-xl">
            ...
            {/* 4 Editorial Brand Declarations with Generous Vertical Rhythm */}
            <div className="space-y-6 mb-10 pt-6 border-t border-white/10">
              {advantages.map((item, index) => (
                <div
                  key={item.num}
                  className={`pb-5 flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-6 ${
                    index < advantages.length - 1 ? "border-b border-white/5" : ""
                  }`}
                >
                  <div className="flex items-center space-x-3 sm:w-48 flex-shrink-0">
                    <span className="text-xs font-mono tracking-widest text-[#C8102E]">
                      {item.num}
                    </span>
                    <span className="font-display text-xs sm:text-sm font-bold uppercase tracking-wider text-[#F3F2EF]">
                      {item.title}
                    </span>
                  </div>
                  <p className="text-xs text-[#F3F2EF]/65 font-light leading-relaxed flex-1">
                    {item.desc}
                  </p>
                </div>
              ))}
          ...
          {/* Right Column: High-Impact Automotive Photograph (Audi Q5 Sportback) */}
          <div className="lg:col-span-6 relative group overflow-hidden bg-black border border-white/10">
            <div className="aspect-[16/11] sm:aspect-[16/10] overflow-hidden">
              <img
                src={audiQ5Image}
                alt="Audi Q5 Sportback importado de Alemania"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black via-black/60 to-transparent">
              ...
              <p className="text-xs font-light text-[#F3F2EF]/90">
                Audi Q5 Sportback: unidades con configuración y mantenimiento oficial en origen.
              </p>
            </div>
          </div>
        </div>
